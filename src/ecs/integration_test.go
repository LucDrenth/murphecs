...
func TestMixingComponentTypes(t *testing.T) {
	...
	t.Run("spawn", func(t *testing.T) {
		...
		entity1, err := world.Spawn(componentA{}, &componentB{})
		assert.NoError(err)
		entity2, err := world.Spawn(&componentA{}, componentB{})
		assert.NoError(err)
		entity3, err := world.Spawn(componentA{}, componentB{})
		assert.NoError(err)
		entity4, err := world.Spawn(&componentA{}, &componentB{})
		assert.NoError(err)
	...
	t.Run("insert", func(t *testing.T) {
		...
		entity1, err := world.Spawn()
		assert.NoError(err)
		err = world.Insert(entity1, componentA{}, &componentB{})
		assert.NoError(err)
		entity2, err := world.Spawn()
		assert.NoError(err)
		err = world.Insert(entity2, &componentA{}, componentB{})
		assert.NoError(err)
		entity3, err := world.Spawn()
		assert.NoError(err)
		err = world.Insert(entity3, componentA{}, componentB{})
		assert.NoError(err)
		entity4, err := world.Spawn()
		assert.NoError(err)
		err = world.Insert(entity4, &componentA{}, &componentB{})
		assert.NoError(err)
