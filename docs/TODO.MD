...
# Logging
**Nice-to-have**
- [feature] Add something to distinguish between logs from application and logs from engine. Including only a part of the caller is not sufficient.
- [bug] Prevent race conditions in Storage
