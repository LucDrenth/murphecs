...
# Project
- [refactor] Rebrand to murphecs or murph-ecs. Move the engine part to a separate repo
- [feature] Linter
...
- [feature] Custom runner for executing the game loop
- [feature] A runner that can run at a fixed rate
