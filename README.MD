...
2. Other ECS I have seen all focus on the Entity Component part, and leave out the System part. Murphecs has an easy to use systems approach that allows for running systems in parallel.
